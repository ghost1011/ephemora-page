...
const i18n = {
  ...
  translations: {
    ...
    'lang.wasmtime.val4': 'General-purpose WASM',
      ...
      'problem.card1_vs': '0.125ms pooled, in-process WASM',
      ...
      'deterministic.sub': 'The foundation for auditability, compliance, and reproducible AI. Fuel consumption correlates R² = 1.000000 per platform (UAT) — zero spread across runs, measured identically on macOS arm64 (20891 fuel) and DGX Grace arm64 (4506 fuel).',
      ...
      'problem.vs1': '0.125ms pooled, in-process WASM',
      ...
      'products.platform_f4': 'Software-HSM (in-memory) — hardware attestation on roadmap',
    ...
    de: {
      ...
      'deterministic.sub': 'Die Grundlage für Auditabilität, Compliance und reproduzierbare KI. Der Fuel-Verbrauch korreliert pro Plattform mit R² = 1.000000 (UAT) — null Streuung über Läufe, identisch gemessen auf macOS arm64 (20891 Fuel) und DGX Grace arm64 (4506 Fuel).',
      ...
      'products.platform_f3': 'Compliance-Mapping (DORA, EU AI Act, NIS2)',
      'products.platform_f4': 'Software-HSM (im Speicher) — Hardware-Attestierung auf der Roadmap',
    ...
    fr: {
      ...
      'problem.card1_vs': "0.125ms pooled, WASM in-process",
      ...
      'deterministic.sub': 'Le fondement de l\'auditabilité, de la conformité et de l\'IA reproductible. La consommation de fuel corrèle à R² = 1.000000 par plateforme (UAT) — zéro écart entre exécutions, mesurée à l\'identique sur macOS arm64 (20891 fuel) et DGX Grace arm64 (4506 fuel).',
      ...
      'problem.vs1': "0.125ms pooled, WASM in-process",
      ...
      'products.platform_f4': "HSM logiciel (en mémoire) — attestation matérielle sur la feuille de route",
    ...
    pl: {
      ...
      'deterministic.sub': 'Fundament dla audytowalności, compliance i replikowalnego AI. Zużycie fuel koreluje z R² = 1.000000 na platformę (UAT) — zero rozrzutu między przebiegami, zmierzone identycznie na macOS arm64 (20891 fuel) i DGX Grace arm64 (4506 fuel).',
...
'footer.tagline': 'Izolowane. Deterministyczne. Zabezpieczone.',
      ...
      'products.platform_f4': 'Software-HSM (w pamięci) — atestacja sprzętowa w planach',
